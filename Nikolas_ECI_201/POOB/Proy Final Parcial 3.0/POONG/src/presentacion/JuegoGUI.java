...
public class JuegoGUI extends JFrame {
    ...
    /**
     * muestra popup de game over por puntaje maximo
     * @param jugador
     */
    ...
    /**
     * muestra popup de game over por fortaleza
     * @param jugador
     */
...
class Tablero extends JPanel{
    ...
    /**
     * mueve la pelota y muestra el puntaje
     */
    public void mover(){
        pong.movePel();
    ...
    /**
     * mueve el personaje correspondiente
     * @param up
     * @param ju2
     */
    ...
    /**
     * compara el puntaje maximo con el de cada jugador
     * @return String
     */
    public String maxP(){
        String player=null;
    ...
    /**
     * muestra el objetivo si esta vivo
     */
    public void alive(){
    ...
    /**
     * mira si la fortaleza del jugador dos es menor que 50
     * @return boolean
     */
    public boolean w1(){
        if(pong.getFor2()<50){
    ...
    /**
     * mira si la fortaleza del jugador uno es menor que 50
     * @return boolean
     */
    public boolean w2(){
        if(pong.getFor1()<50){
    ...
    /**
     * muestra el bloque si esta vivo
     */
    public void aliveB(){
