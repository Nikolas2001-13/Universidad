...
public class Sinap{
    ...
    public void adicione(String nombre, String name,String ubicacion, String area, String descripcion)throws SINAPExcepcion{
         if(name.equals("")||nombre.equals("")||ubicacion.equals("")||area.equals("")||descripcion.equals("")){
            throw new SINAPExcepcion(SINAPExcepcion.CAMPO_VACIO);
        }else if(isInArea(nombre, name, ubicacion, area, descripcion)){
    ...
    private boolean isInArea(String nombre, String name,String ubicacion, String area, String descripcion){
        Area area1 = new Area(nombre,name,ubicacion,area,descripcion);
        for (Area a:areas){
            if (a.toString().equals(area1.toString())){
                return true;
            }
        }
        return false;
